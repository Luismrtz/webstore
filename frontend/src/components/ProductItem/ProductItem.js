...
const ProductItem = ({product: {_id, title, img, info, price, inCart}, isToggled}) => {
        ...
        <div className={(isToggled === true ? styles.container : styles.containerFlip)}>
            ...
            <div   className={styles.imgOverlay}>
              ...
              <div className={styles.overlayContainer}>
                    ...
                    <Link to={'/details/' + title}  className={styles.overlay}></Link> 
                    <div className={styles.bwrapper}>
                            <Link to={'/details/' + title} className={styles.button1}>Quick Shop</Link>
